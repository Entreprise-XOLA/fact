...
<div id="q-app">
  ...
  <!--
    ...
    <div class="row" style="margin-top: 20px;">
      ...
      <q-select style="width: 85px;" borderless v-model="typefact" :options="options" option-value="idtypefacture"
              option-label="valeurfact" emit-value map-options stack-label /> 
      </div>-->
...
<div class="row" style="margin-bottom: 30px;">
  ...
  -->
      <div class="col-6">
          ...
          <q-btn color="blue" :disable="loading" label="Imprimer" style="color: white; width: 400px; text-transform: none; font-weight : bold;" @click="imprimer"></q-btn>
      </div>
